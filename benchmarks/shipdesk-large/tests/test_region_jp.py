from shipdesk.regions import jp as m


def test_valid_and_invalid_postal():
    assert m.is_valid_postal("100-0001")
    assert not m.is_valid_postal("10-0001")


def test_normalize_postal_strips_and_uppercases():
    assert m.normalize_postal("  100-0001  ") == m.normalize_postal("100-0001")
...
def test_address_layout_contains_parts():
    text = m.format_address("Ada", "1 Main St", "Town", "ST", "100-0001")
