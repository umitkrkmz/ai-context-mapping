"""Shipping insurance: Insurance premium by declared value in cents.
...
TIERS: List[Tier] = [
    Tier("none", 0, 0),
    Tier("basic", 10000, 199),
    Tier("plus", 50000, 599),
    Tier("premium", 200000, 1499),
]
...
def distance_to_next(value: int) -> Optional[int]:
    """Return how many more cents are needed to reach the next tier."""
