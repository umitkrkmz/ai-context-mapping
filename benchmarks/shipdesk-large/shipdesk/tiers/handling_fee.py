"""Handling fee: Handling surcharge by parcel weight; heavy means MORE than 20 kg (strict).
...
TIERS: List[Tier] = [
    Tier("standard", 0, 0),
    Tier("heavy", 20000, 500),
    Tier("oversize", 50000, 1500),
]
...
def distance_to_next(value: int) -> Optional[int]:
    """Return how many more grams are needed to reach the next tier."""
