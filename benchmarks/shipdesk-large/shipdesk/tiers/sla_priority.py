"""Support SLA priority: Support priority by ticket age in hours; p2 means MORE than 24 hours (strict).
...
def distance_to_next(value: int) -> Optional[int]:
    """Return how many more hours are needed to reach the next tier."""
